...
- (void)dismiss:(id<UIViewControllerContextTransitioning>)transitonContext {
    ...
    // 取出present时的截图用于动画
    UIView *tempView = containerView.subviews[containerView.subviews.count-2];
